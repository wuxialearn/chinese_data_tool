...
class UnitView extends StatefulWidget {
  ...
  final Function updateHomeHsk;
  const UnitView(
      {Key? key,
      required this.unit,
      required this.name,
      required this.courseName,
      required this.updateHomeHsk})
      : super(key: key);
                        ...
                        IconButton(
                            onPressed: () {
                              Future<List<Map<String, dynamic>>>
                                  newWordsFuture = SQLHelper.getNewWords(
              ...
              SliverToBoxAdapter(
                child: HskWrapView(
                    ...
                    updateWords: () {
                      setState(() {
                        hskFuture =
                            SQLHelper.getUnitWithMissingSentences(widget.unit);
                        //hskFuture = SQLHelper.getUnit(widget.unit);
                      });
                    }),
              ),
...
class _Sentences extends StatelessWidget {
  const _Sentences(
      ...
      required this.updateSentencesFuture});
                                                              ...
                                                              onPressed: () {
                                                                if (unitFormKey
                                                                  ...
                                                                  unitFormKey
                                                                      .currentState!
                                                                      .save();
                                                                  SQLHelper.updateSentenceSubunit(
                                                                      id: sentences[
                                                                              index]
                                                                          [
                                                                          "id"],
