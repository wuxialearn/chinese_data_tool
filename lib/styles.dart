...
class Styles {
  static ButtonStyle blankButton = ButtonStyle(
    ...
    backgroundColor: MaterialStateProperty.all<Color>(const Color(0xFFD9EAFD)),
  ...
  static ButtonStyle blankButton2 = ButtonStyle(
    ...
    overlayColor: MaterialStateProperty.all(Colors.transparent),
    foregroundColor: MaterialStateProperty.all<Color>(const Color(0xFF6D7275)),
    backgroundColor: MaterialStateProperty.all<Color>(const Color(0xFFEEEFF2)),
    shape: MaterialStateProperty.all<RoundedRectangleBorder>(
        RoundedRectangleBorder(
  ...
  static ButtonStyle blankButton3 = ButtonStyle(
    overlayColor: MaterialStateProperty.all(Colors.transparent),
    backgroundColor: MaterialStateProperty.all<Color>(const Color(0x00FFFFFF)),
    shape: MaterialStateProperty.all<RoundedRectangleBorder>(
        RoundedRectangleBorder(
      borderRadius: BorderRadius.circular(15.0),
    )),
