              ...
              children: [
                Column(children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                        fontSize: 25,
                        color: hskList.containsKey("completed")
                            ? hskList["completed"]
                                ? Colors.black
                                : Colors.red
                            : Colors.black),
...
class _HskDialog extends StatefulWidget {
  final Map<String, dynamic> hskList;
  final Function updateWords;
  const _HskDialog({Key? key, required this.hskList, required this.updateWords})
      : super(key: key);
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                if (unitFormKey.currentState!.validate()) {
                                  ...
                                  SQLHelper.updateSubunit(
                                      id: widget.hskList["id"],
                                      subunit: newUnit);
                                  widget.updateWords();
                                  Navigator.pop(context);
                                }
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                if (editWordKey.currentState!.validate()) {
                                  ...
                                  print(
                                      "$newTranslation, $newHanzi, $newPinyin");
                                  SQLHelper.updateWord(
                                      id: widget.hskList["id"],
